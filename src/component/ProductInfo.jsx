    ...
    return (
        <Box >
            <Flex
                ...
                <Text
                    color={"hsl(220, 14%, 75%)"}>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. <br /> Voluptatum error suscipit atque, recusandae, totam in velit officia <br /> impedit autem, quisquam alias reiciendis cum. Dolores corrupti ducimus nobis? <br /> Quis, nemo architecto?
                </Text>
                <Box ml='3'>
                    <Text
                        fontWeight='bold'
